...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_whileStatement, 6, .production_id = 40),
  ...
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_whileStatement, 7, .production_id = 43),
