...
enum {
  ...
  field_statement = 14,
  field_string_constant = 15,
  field_subroutine_dec = 16,
  field_term = 17,
  field_type = 18,
  field_value = 19,
  field_var_dec = 20,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 2, .production_id = 22),
  [37] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [39] = {.entry = {.count = 1, .reusable = false}}, SHIFT(47),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 1, .production_id = 19),
  ...
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_repeat1, 2), SHIFT_REPEAT(47),
  [62] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_repeat1, 2), SHIFT_REPEAT(47),
  [65] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineCall, 5),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subroutineCall, 5),
  ...
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 1, .production_id = 17),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_term, 1, .production_id = 17),
  [85] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 4),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_term, 4),
  [91] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineCall, 4, .production_id = 29),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subroutineCall, 4, .production_id = 29),
  [97] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [99] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [101] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_keywordConstant, 1),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_keywordConstant, 1),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 2),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_term, 2),
  [111] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2),
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2), SHIFT_REPEAT(91),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2), SHIFT_REPEAT(106),
  [121] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2), SHIFT_REPEAT(104),
  [124] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2), SHIFT_REPEAT(92),
  [127] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2), SHIFT_REPEAT(4),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 1, .production_id = 18),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_term, 1, .production_id = 18),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_op_term, 2, .production_id = 26),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_op_term, 2, .production_id = 26),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 3),
  [140] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_term, 3),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stringConstant, 3, .production_id = 25),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stringConstant, 3, .production_id = 25),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineCall, 6, .production_id = 30),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subroutineCall, 6, .production_id = 30),
  ...
  [164] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_op, 1),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat1, 2),
  [168] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat1, 2), SHIFT_REPEAT(72),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_class_repeat1, 2),
  [173] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_class_repeat1, 2), SHIFT_REPEAT(73),
  [176] = {.entry = {.count = 1, .reusable = false}}, SHIFT(134),
  [178] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_varDec, 5, .production_id = 27),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifStatement, 6),
  [184] = {.entry = {.count = 1, .reusable = true}}, SHIFT(127),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_varDec, 4, .production_id = 24),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifStatement, 7),
  [190] = {.entry = {.count = 1, .reusable = true}}, SHIFT(132),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_classVarDec, 4, .production_id = 6),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifStatement, 11),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_doStatement, 3),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_letStatement, 5, .production_id = 28),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_classVarDec, 5, .production_id = 8),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_returnStatement, 3),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_returnStatement, 2),
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_whileStatement, 6),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_class_repeat2, 2),
  [212] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_class_repeat2, 2), SHIFT_REPEAT(70),
  [215] = {.entry = {.count = 1, .reusable = true}}, SHIFT(122),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_whileStatement, 7),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifStatement, 9),
  [221] = {.entry = {.count = 1, .reusable = true}}, SHIFT(129),
  [223] = {.entry = {.count = 1, .reusable = false}}, SHIFT(131),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifStatement, 10),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineDec, 6, .production_id = 11),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineBody, 3, .production_id = 20),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineBody, 2),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineBody, 3, .production_id = 21),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineBody, 4, .production_id = 23),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineDec, 7, .production_id = 14),
  [239] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameterList_repeat1, 2, .production_id = 16), SHIFT_REPEAT(62),
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameterList_repeat1, 2, .production_id = 16),
  ...
  [250] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expressionList_repeat1, 2), SHIFT_REPEAT(15),
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expressionList_repeat1, 2),
  [255] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [257] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_classVarDec_repeat1, 2, .production_id = 9), SHIFT_REPEAT(121),
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_classVarDec_repeat1, 2, .production_id = 9),
  [262] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expressionList, 2),
  [266] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameterList, 1, .production_id = 10),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameterList, 2, .production_id = 13),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expressionList, 1),
  ...
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lvalue, 1),
  [282] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_classVarDec_repeat1, 2, .production_id = 7),
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameterList_repeat1, 2, .production_id = 15),
  [288] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 2, .production_id = 12),
  ...
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lvalue, 4),
  ...
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 6, .production_id = 5),
  ...
  [350] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 5, .production_id = 4),
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 5, .production_id = 3),
  ...
  [362] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 4, .production_id = 2),
  [364] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [366] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, .production_id = 1),
