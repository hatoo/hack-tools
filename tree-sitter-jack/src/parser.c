...
enum {
  ...
  aux_sym_expressionList_repeat1 = 77,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_repeat1, 2), SHIFT_REPEAT(44),
  [56] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_repeat1, 2), SHIFT_REPEAT(44),
  ...
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineCall, 6, .production_id = 22),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subroutineCall, 6, .production_id = 22),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2),
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2), SHIFT_REPEAT(122),
  [88] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2), SHIFT_REPEAT(119),
  [91] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2), SHIFT_REPEAT(104),
  [94] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2), SHIFT_REPEAT(91),
  [97] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat2, 2), SHIFT_REPEAT(4),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineCall, 5),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subroutineCall, 5),
  [104] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 2),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_term, 2),
  ...
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineCall, 4, .production_id = 21),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subroutineCall, 4, .production_id = 21),
  [120] = {.entry = {.count = 1, .reusable = true}}, SHIFT(65),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_keywordConstant, 1),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_keywordConstant, 1),
  [128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_expression_repeat1, 2),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stringConstant, 3, .production_id = 19),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stringConstant, 3, .production_id = 19),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineCall, 3),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subroutineCall, 3),
  ...
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat1, 2),
  [158] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subroutineBody_repeat1, 2), SHIFT_REPEAT(73),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_class_repeat1, 2),
  [163] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_class_repeat1, 2), SHIFT_REPEAT(72),
  [166] = {.entry = {.count = 1, .reusable = false}}, SHIFT(138),
  [168] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_varDec, 4, .production_id = 18),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifStatement, 7),
  [174] = {.entry = {.count = 1, .reusable = true}}, SHIFT(132),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_varDec, 5, .production_id = 20),
  ...
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifStatement, 11),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_class_repeat2, 2),
  [190] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_class_repeat2, 2), SHIFT_REPEAT(67),
  [193] = {.entry = {.count = 1, .reusable = true}}, SHIFT(131),
  [195] = {.entry = {.count = 1, .reusable = true}}, SHIFT(128),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifStatement, 10),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ifStatement, 9),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_letStatement, 8),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_whileStatement, 7),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_classVarDec, 4, .production_id = 6),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_whileStatement, 6),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_classVarDec, 5, .production_id = 8),
  [211] = {.entry = {.count = 1, .reusable = false}}, SHIFT(117),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_returnStatement, 2),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_returnStatement, 3),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_doStatement, 3),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineBody, 3, .production_id = 17),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineBody, 3),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineBody, 4, .production_id = 17),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineDec, 6, .production_id = 11),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineBody, 2),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutineDec, 7, .production_id = 14),
  [231] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expressionList, 1),
  [235] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameterList, 1, .production_id = 10),
  [239] = {.entry = {.count = 1, .reusable = true}}, SHIFT(129),
  [241] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [243] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameterList_repeat1, 2, .production_id = 16), SHIFT_REPEAT(70),
  [246] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameterList_repeat1, 2, .production_id = 16),
  [248] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [250] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [252] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expressionList_repeat1, 2), SHIFT_REPEAT(13),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expressionList_repeat1, 2),
  [257] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [259] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_classVarDec_repeat1, 2, .production_id = 9), SHIFT_REPEAT(129),
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_classVarDec_repeat1, 2, .production_id = 9),
  ...
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameterList_repeat1, 2, .production_id = 15),
  [272] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [274] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_classVarDec_repeat1, 2, .production_id = 7),
  [278] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 2, .production_id = 12),
  ...
  [296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 4, .production_id = 2),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 5, .production_id = 3),
  ...
  [312] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, .production_id = 1),
  ...
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 5, .production_id = 4),
  [342] = {.entry = {.count = 1, .reusable = true}}, SHIFT(96),
  [344] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [346] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 6, .production_id = 5),
